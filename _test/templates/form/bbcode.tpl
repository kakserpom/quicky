...
{$result}
</fieldset><br />{if sizeof(form->elements->mybbarea->_bbcode->stat)}<fieldset><legend>Statistics</legend>
...
<br />{/if}
{/if}
Put BBcode:<br />{textarea join='mybbarea' cols=80 rows=10 value=(form->elements->mybbarea)}
<br /><br />
{input join='btn1'}
{/form}