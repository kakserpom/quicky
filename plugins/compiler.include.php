...
function quicky_compiler_include($params,$compiler)
{
 ...
 static $tmp = 0;
 if (!isset($params['file'])) {return $compiler->_syntax_error('include: missing \'file\' parameter in include function');}
 if (isset($params['assign'])) {$params['assign'] = $compiler->_varname($params['assign']);}
 $assign = '';
