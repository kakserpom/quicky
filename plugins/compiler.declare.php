...
{
 if (!isset($params['name'])) {return $compiler->_syntax_error('declare: missing "name" parameter in include function');}
 ...
 if ($name == 'depart_scopes') {$compiler->parent->local_depart_scopes = (bool) $value;}
 return '';
}
