...
function quicky_block_for($params,$content,$compiler)
{
 ...
 if (!isset($params['loop'])) {return $compiler->_syntax_error('Missing parameter \'loop\' in for tag.');}
 if (!isset($params['value'])) {return $compiler->_syntax_error('Missing parameter \'value\' in for tag.');}
