...
function quicky_block_foreach($params,$content,$compiler)
{
 ...
 if (isset($params['key'])) {$params['key'] = $compiler->_varname($params['key']);}
 if (isset($params['item'])) {$params['item'] = $compiler->_varname($params['item']);}
 if (isset($params['value'])) {$params['value'] = $compiler->_varname($params['value']);}
 ...
 else {$return .= ' '; $name = ''; $block = $compiler->_tag_token($content,$block_name);}
